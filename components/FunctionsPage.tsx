...
const funcTranslations = {
  en: {
    ...
    seriesDesc: "Roadmap for French wheel sectors: Voisins du Zéro, Orphelins, and Tiers du Cylindre.",
  ...
  zh: {
    ...
    seriesDesc: "零区(Voisins)、孤注(Orphelins)、三区(Tiers)分区走势路单。",
    matrixDesc: "10x10尾数转移矩阵，追踪末尾数字0-9的演变关系。",
  ...
  ja: {
    ...
    seriesDesc: "フレンチホイールセクター（0区, 孤立区, 3区）のロードマップ。",
  ...
  es: {
    ...
    seriesDesc: "Hoja de ruta para sectores: Voisins, Orphelins y Tiers.",
  ...
  ko: {
    ...
    seriesDesc: "휠 섹터(0구역, 고립구역, 3구역) 흐름 로드맵.",
  ...
  vi: {
    ...
    seriesDesc: "Sơ đồ luồng cho các khu vực vòng quay Pháp: Voisins du Zéro, Orphelins, Tiers du Cylindre.",
